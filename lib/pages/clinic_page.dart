...
class clinic_page extends StatelessWidget {
  const clinic_page({Key? key}) : super(key: key);
            ...
            Center(
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 16.0),
                  Image.asset(
                    'assets/images/c-Centro.png',
                    fit: BoxFit.contain,
                    height: 210.0,
                  ),
                  const SizedBox(height: 16.0),
                  buildClickableText(
                    '¿Buscas Centros de Salud CercanOs?. Clic Aquí',
                    'https://beacons.ai/alan24/centrosdesalud', // Reemplaza con tu enlace real
                  ),
                  const SizedBox(height: 16.0),
                  // const Spacer(),
                  // Botón
